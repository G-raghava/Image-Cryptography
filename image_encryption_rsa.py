...
Original file is located at
    https://colab.research.google.com/drive/1CZ0m16KQlhme1k73jZg83irbQSr_IkLk
"""
...
#Step 3: Find E such that GCD(E,eulerTotient)=1(i.e., e should be co-prime)
# such that it satisfies this condition:-  1<E<eulerTotient
...
# 1.we randomly choose D &check which condition is satisfying above condition.
# 2.For Finding D we can Use Extended Euclidean Algorithm: ax+by=1 
#i.e., eulerTotient(x)+E(y)=GCD(eulerTotient,e)
